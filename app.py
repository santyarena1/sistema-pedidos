...
def tarea_actualizar_mayoristas():
    with app.app_context():
        ...
        try:
            ...
            todos_los_resultados = resultados_invid + resultados_newbytes + resultados_air + resultados_polytech

            if todos_los_resultados:
                guardar_resultados_db(todos_los_resultados)
                print(f"-> Tarea finalizada. Total de {len(todos_los_resultados)} productos procesados.")
            else:
                print("-> No se obtuvieron productos de los mayoristas en esta ejecución.")
